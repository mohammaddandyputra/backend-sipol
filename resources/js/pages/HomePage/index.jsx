...
import Background from "../../../../public/img/hero-bg.jpg";

import RegisterKalibrasiButton from "../../components/button/RegisterKalibrasiButton";

import FormPengajuanKalibrasi from "../../components/form";
import Login from "../../components/auth/login";

const Slide = () => {
    return (
        <section id="hero" className="d-flex align-items-center" style={{backgroundImage: `url(${Background})`}}>
            <div className="container position-relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="text-center">
                    <a href="#about" className="btn-get-started scrollto">Dapatkan penawaran untuk kalibrasi</a>
                </div>
            </div>
        </section>
    );
            ...
            <div className="container">
                ...
                <div className="row align-items-center ">
                    <div className="col-lg-2 justify-content-center" data-aos="zoom-in">
                        <img src="assets/img/polaritas/1.jpg"/>
                    </div>
                </div>
            </div>
        </section>
